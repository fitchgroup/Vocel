...
class Post extends Model {
  ...
  const Post._internal({required this.id, required postAuthor, required postContent, required postGroup, likes, comments, createdAt, updatedAt}): _postAuthor = postAuthor, _postContent = postContent, _postGroup = postGroup, _likes = likes, _comments = comments, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Post({String? id, required String postAuthor, required String postContent, required ProfileRole postGroup, List<String>? likes, List<Comment>? comments}) {
  ...
  String toString() {
    ...
    buffer.write("postGroup=" + (_postGroup != null ? enumToString(_postGroup)! : "null") + ", ");
  ...
  Post copyWith({String? postAuthor, String? postContent, ProfileRole? postGroup, List<String>? likes, List<Comment>? comments}) {
    return Post._internal(
      id: id,
  ...
  Post.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _postGroup = enumFromString<ProfileRole>(json['postGroup'], ProfileRole.values),
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'postAuthor': _postAuthor, 'postContent': _postContent, 'postGroup': enumToString(_postGroup), 'likes': _likes, 'comments': _comments?.map((Comment? e) => e?.toJson()).toList(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'id': id, 'postAuthor': _postAuthor, 'postContent': _postContent, 'postGroup': _postGroup, 'likes': _likes, 'comments': _comments, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };
